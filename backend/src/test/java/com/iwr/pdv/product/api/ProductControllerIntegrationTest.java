        ...
        mockMvc.perform(get("/api/products/{productId}/label", savedProduct.getId())
                ...
                .andExpect(result -> {
                    ...
                    if (!html.contains("Vestido Festa")
                            ...
                            || !html.contains("grid-template-rows: 6mm 17.8mm 4.2mm;")
                            || !html.contains("padding: 0.5mm;")
                            || !html.contains("-webkit-line-clamp: 2;")
                            || !html.contains("width: 49mm;")
                            || !html.contains("height: 17.8mm;")
